...
import { ADMIN_ROUTE, BASKET_ROUTE, DEVICE_ROUTE, LOGIN_ROUTE, NOTFOUND_ROUTE, REGISTRATION_ROUTE, SHOP_ROUTE } from "./utils/consts";


export const privateRoutes = [
    {path: ADMIN_ROUTE, component: <Admin/>, exact: false, id:11},
    {path: BASKET_ROUTE, component: <Basket/>, exact: true, id:12},
    {path: DEVICE_ROUTE + '/:id', component: <DevicePage/>, exact: true, id:14},
]
