          ...
          <Row className='pl-3 pr-3 mt-4 d-flex align-items-center  justify-content-between flex-wrap '>
            {isLogin
              ...
              <div
                ...
                style={{ width: '60%' }}>
                нет аккаунта? <NavLink className='text-success' to={REGISTRATION_ROUTE}>зарегистрируйтесь</NavLink>
              </div>
              :
              <div
                className='  pl-3 text-start'
                variant='outline-success'
                style={{ width: '60%' }}
              > Уже есть аккаунт? <NavLink className='text-success' to={LOGIN_ROUTE}>Войти</NavLink></div>
            }
